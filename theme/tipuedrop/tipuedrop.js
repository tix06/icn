                    ...
                    if ($obj.val())
                    {
                         ...
                         for (var i = 0; i < tipuedrop_in.pages.length; i++)
                         {
                              ...
                              if ((tipuedrop_in.pages[i].title.search(pat) != -1 || tipuedrop_in.pages[i].text.search(pat) != -1 || tipuedrop_in.pages[i].tags.search(pat) != -1) && c < set.show)
                              {
                                   ...
                                   out += '><div class="tipue_drop_item"><div class="tipue_drop_right"><div class="tipue_drop_right_title">' + tipuedrop_in.pages[i].title + '</div><div class="tipue_drop_right_text">' + tipuedrop_in.pages[i].resume + '</div></div></div></a>';
                                   c++;
                              }
                         }
                         if (c != 0)
